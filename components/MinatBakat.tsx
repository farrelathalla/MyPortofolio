  ...
  return ( 
    <section>
        <div className="w=full h-full bg-[#2f1034] px-10 md:px-20 relative" id="about">
            ...
            <div className="relative z-20 flex justify-center lg:text-5xl text-center font-bold text-white text-2xl md:gap-1 lg:gap-2 pt-28 sm:pt-20 sm:text-3xl" data-aos="zoom-in">
                Here is some of my
